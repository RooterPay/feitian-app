...
import me.demo.SvrHelper;
import me.demo.bean.CAPublicKeyBean;
import me.demo.bean.CRLBean;
import me.demo.bean.EMVAcquirerParamsBean;
import me.demo.bean.EMVAppParamsBean;
import me.demo.bean.EMVCLAppParamsBean;
import me.demo.bean.EMVCLDRLBean;
import me.demo.bean.ExceptionListBean;
import me.demo.bean.XmlDataBean;
...
import me.demo.tlv.TLV;
import me.demo.tlv.TLVList;
import me.demo.utils.BytesUtil;
import me.demo.utils.XmlParser;
 ...
 * @desc
 */
public abstract class BaseEmvActivity extends AppCompatActivity implements SvrHelper.ServiceListener {
    ...
    protected void startTransaction(String amt, TransactionType transactionType) {
        if (!hasInitEmv) {
            initTransaction();
        }
        doTransaction(amt, transactionType);
    }
    ...
    private void doTransaction(String amt, TransactionType transactionType) {
        if (emvRunning) {
            SvrHelper.instance().cancelOperation();
            stopEmv(IPinpadCode.OTHER_UNKNOWN, null);
            emvRunning = false;
        ...
        switch (type) {
            case TYPE_EMV_ACQUIRER_PARAM:
                for (XmlDataBean bean : xmlList) {
                    ...
                    System.arraycopy(appData, 0, desData, 0, ((EMVAcquirerParamsBean) bean).getTlvLens());
            ...
            case TYPE_APP_PARAM_EMV:
                for (XmlDataBean bean : xmlList) {
                    ...
                    System.arraycopy(appData, 0, desData, 0, ((EMVAppParamsBean) bean).getTlvLens());
            ...
            case TYPE_APP_PARAM_EMVCL:
                for (XmlDataBean bean : xmlList) {
                    ...
                    System.arraycopy(appData, 0, desData, 0, ((EMVCLAppParamsBean) bean).getTlvLens());
